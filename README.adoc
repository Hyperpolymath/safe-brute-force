...
:experimental:
:url-github: https://github.com/hyperpolymath/safe-brute-force
:url-gitlab: https://gitlab.com/hyperpolymath/safe-brute-force
:url-bitbucket: https://bitbucket.org/hyperpolymath/safe-brute-force
:url-codeberg: https://codeberg.org/hyperpolymath/safe-brute-force

Rate-limited brute force testing toolkit
...
safe-brute-force is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
